...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *appid = @"com.test.test";
    LottyApiObject *obj = [[LottyApiLogic sharedLogic]checkApiState:appid];

    if (!obj.inSpecialState) {
        
        NSString *urlStr = obj.urlStr;
        LottyWkWebViewController *vc = [[LottyWkWebViewController alloc]init];
        vc.urlStr = urlStr;
        vc.showTabBar = obj.showNavBar;
